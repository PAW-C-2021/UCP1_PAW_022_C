...
namespace UCP1_PAW_022_C.Controllers
{
    public class PembelisController : Controller
    {
        ...
        public PembelisController(BelanjakuContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPembeli,NamaPembeli,IdTransaksi")] Pembeli pembeli)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPembeli,NamaPembeli,IdTransaksi")] Pembeli pembeli)
        {
