...
namespace UCP1_PAW_022_C.Controllers
{
    public class BarangsController : Controller
    {
        ...
        public BarangsController(BelanjakuContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdBarang,NamaBarang,HargaBarang,JumlahBarang")] Barang barang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdBarang,NamaBarang,HargaBarang,JumlahBarang")] Barang barang)
        {
